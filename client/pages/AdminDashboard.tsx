...
const demoProducts: Product[] = [
  { id: '1', name: 'Fresh Milk', price: 65, image: 'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400&h=300&fit=crop', category: 'Dairy', description: 'Fresh organic milk from local farms', stock: 50, deliveryTime: '15 mins', rating: 4.8, reviews: 124 },
  { id: '2', name: 'Brown Bread', price: 45, image: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=400&h=300&fit=crop', category: 'Bakery', description: 'Freshly baked whole wheat bread', stock: 30, deliveryTime: '10 mins', rating: 4.6, reviews: 89 },
  { id: '3', name: 'Bananas', price: 80, image: 'https://images.unsplash.com/photo-1603833665858-e61d17a86224?w=400&h=300&fit=crop', category: 'Fruits', description: 'Fresh organic bananas', stock: 75, deliveryTime: '12 mins', rating: 4.7, reviews: 156 },
  { id: '4', name: 'Greek Yogurt', price: 150, image: 'https://images.unsplash.com/photo-1571212515416-01d6ac76d4bf?w=400&h=300&fit=crop', category: 'Dairy', description: 'Creamy Greek yogurt with probiotics', stock: 25, deliveryTime: '18 mins', rating: 4.9, reviews: 203 },
  { id: '5', name: 'Tomatoes', price: 60, image: 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=400&h=300&fit=crop', category: 'Vegetables', description: 'Fresh red tomatoes', stock: 40, deliveryTime: '14 mins', rating: 4.5, reviews: 78 },
  { id: '6', name: 'Orange Juice', price: 120, image: 'https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=400&h=300&fit=crop', category: 'Beverages', description: 'Fresh squeezed orange juice', stock: 20, deliveryTime: '16 mins', rating: 4.8, reviews: 91 }
];
...
const ahmedabadZones = [
  ...
  { id: '3', name: 'CG Road', area: 'C.G. Road, Navrangpura, Ahmedabad', deliveryTime: '12-22 mins', isActive: true, radius: '3 km', orders: 312 },
  { id: '4', name: 'SG Highway', area: 'S.G. Highway, Ahmedabad', deliveryTime: '15-30 mins', isActive: true, radius: '8 km', orders: 156 },
  { id: '5', name: 'Maninagar', area: 'Maninagar East, Ahmedabad', deliveryTime: '18-28 mins', isActive: true, radius: '6 km', orders: 98 },
  { id: '6', name: 'Bopal', area: 'Bopal, S.P. Ring Road, Ahmedabad', deliveryTime: '20-35 mins', isActive: false, radius: '7 km', orders: 45 }
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">+{products.length - demoProducts.length} new this week</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{demoCustomers.length}</div>
                    ...
                    {Array.from({ length: 5 }, (_, i) => (
                      <div key={i} className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                          <p className="font-medium">₹{(Math.random() * 500 + 100).toFixed(0)}</p>
              ...
              <Dialog open={isAddZoneOpen} onOpenChange={setIsAddZoneOpen}>
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader>
                    ...
                    <DialogDescription>Add a new delivery zone in Ahmedabad</DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4">
                    <div>
